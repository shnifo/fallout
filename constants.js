...
6. Extended: +1 range */
    const weapons = {
        E1: [[6, "Pistol", "5 P", "small", "mid", "AGI", "30c"],
        ...
        E4: [[6, "Pulse Rifle", "2x5 N", "power", "long", "INT", "60c"],
        [8, "Photon Rifle", "2x6 N", "power", "long", "INT", "80c"],
        [10, "Electron Rifle", "2x7 N", "power", "long", "INT", "100c"],
        [12, "Ion Rifle", "2x8 N", "power", "long", "INT", "120c"],
        [14, "Plasma Rifle", "2x9 N", "power", "long", "INT", "140c"],
...
export const recipeTable = [
    ...
    { book: "Tinker's Digest", recipe: "Hackerator + 1 of each scrap = Scouter: before initiative, learn weapon+armor of 1 enemy, or search any tile to short range, bulky, 50c"},
...
export const perkData = {
    ...
    ENDURANCE: [
        { name: "Mirror Force", desc: "When you lose HP while you have defend or from a crit, the attacker loses the same amount." },
...
export const backgroundData = [
    ...
    { name: "Doctor", desc: "You can convert 2 Armor Scraps into 1 Bandage." },
    ...
    { name: "Chemist", desc: "You can convert any 3 Medicine into 2 of another Medicine." },
...
export const RuinsTable = { // abundant = +1 to roll, +1 reroll, and no multi-scavenge penalty
    11: "Office: Scavenges contain a vending machine with hidden 1d6 healthy water for 10c each. Autojacker to open.",
    ...
    16: "Factory: Contains a random heavy multitech (functions as two techs combined)",
    ...
    36: "Bank: Deposit cash, grows 20% on level up. Withdraw at any bank.",
...
export const townQuests = [ //main quest rewards = 2d6 x 10c
    ...
    { roll: 63, text: `New Sherrif in Town – A group of mercenaries are offering suspicious "protection". Investigate whether it's a shakedown, a genuine threat, or a trap.` },
...
export const moraleTable = [
  { value: "+5", effect: "unlock quest to join faction (must defeat tier 6 boss battle)" },
  { value: "+4", effect: "40% discount" },
  { value: "+3", effect: "upgrade faction shop" },
  { value: "+2", effect: "20% discount" },
  { value: "+1", effect: "unlock faction shop" },
  { value: "-1", effect: "-1 shop" },
